...
export function PropertyDetailModal({ property, isOpen, onClose }: PropertyDetailModalProps) {
  ...
  // Reset image index cuando cambie la propiedad o se cierre
  React.useEffect(() => {
    if (isOpen) {
              ...
              <div className="grid grid-cols-[1.2fr_0.8fr] gap-8">
                ...
                <div className="space-y-5">
                  ...
                  <div className="bg-gray-50 rounded-xl p-5">
                    ...
                    {property.rating && (
                      <Badge className="mt-3 text-sm py-1 px-3">⭐ {property.rating}</Badge>
                    )}
                  </div>
                  ...
                  <div>
                    <div className="grid grid-cols-3 gap-2">
                      <Button 
                        ...
                        onClick={() => { /* noop: ficha técnica - implementar si es necesario */ }}
                      >
                        Ficha técnica
                      </Button>
                      ...
                      <Button
                        ...
                        onClick={() => { /* noop: marcar como no interesa */ }}
                      >
                        No interesa
                      </Button>
                    </div>
